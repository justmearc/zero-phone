...
class Toolbar():
    def __init__(self, fona):
        ...
        #Setup fonts
        self.font = pygame.font.Font('/home/pi/zero-phone/arial.ttf', 14)
        ...
        self.bat_left_rect.centerx = 185
        self.bat_left_rect.centery = 10
    ...
    def check_reception(self, rects, y):
        ...
        self.one =   pygame.Rect(7, y + 12, 3, 5)
        self.two =   pygame.Rect(15, y + 8, 3, 8)
        self.three = pygame.Rect(25,  y + 5, 3, 11)
        self.four =  pygame.Rect(34,  y + 2, 3, 14)
