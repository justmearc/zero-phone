...
class Run():
    def __init__(self, fona):
        ...
        for i in range(0, 3):
            for i in range(0, 3):
                ...
                self.numbers['rects'][num].centerx = x + 23
                self.numbers['rects'][num].centery = y + 23
        ...
        self.numbers['rects'][-1].x = 20
        self.numbers['rects'][-1].centery = 42
    ...
    def get_events(self, event):
        if self.ongoing_call == False:
            if event.pos[0] > 23 and event.pos[0] < 68:
                if event.pos[1] > 78 and event.pos[1] < 124:
                    self.call_number = self.call_number + '1'
                if event.pos[1] > 137 and event.pos[1] < 182:
                    self.call_number = self.call_number + '4'
                if event.pos[1] > 195 and event.pos[1] < 241:
                    self.call_number = self.call_number + '7'
                if event.pos[1] > 254 and event.pos[1] < 299:
                    self.call_number = self.call_number + '0'

            if event.pos[0] > 91 and event.pos[0] < 137:
                if event.pos[1] > 78 and event.pos[1] < 124:
            ...
            if event.pos[0] > 137 and event.pos[0] < 182:
                if event.pos[1] > 78 and event.pos[1] < 124:
